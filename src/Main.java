...
public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(room1.getRoom()+" - lůžek: "+room1.getNumberOfBed()+", cena: "+room1.getPrice()+"Kč/noc, balkon:"+room1.getHasBalcony()+", výhled na moře:"+room1.getSea());
        System.out.println(room2.getRoom()+" - lůžek: "+room2.getNumberOfBed()+", cena: "+room2.getPrice()+"Kč/noc, balkon:"+room2.getHasBalcony()+", výhled na moře:"+room2.getSea());
        System.out.println(room3.getRoom()+" - lůžek: "+room3.getNumberOfBed()+", cena: "+room3.getPrice()+"Kč/noc, balkon:"+room3.getHasBalcony()+", výhled na moře:"+room3.getSea());
